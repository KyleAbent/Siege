...
kAlienStructureEffects = 
{
    ...
    web_charge =
    {
        effects =
        {
            {sound = "sound/NS2.fev/alien/structures/deploy_small"}
        }
    },
    ...
    clog_spawn_reaper =
    {
        clogSpawnEffects =
        {
            {parented_cinematic = "cinematics/alien/gorge/clog_spawn_reaper.cinematic"},
        } 
    },
    ...
    clog_spawn_nocturne =
    {
        clogSpawnEffects =
        {
            {parented_cinematic = "cinematics/alien/gorge/clog_spawn_nocturne.cinematic"},
        } 
    },
    ...
    clog_spawn_kodiak =
    {
        clogSpawnEffects =
        {
            {parented_cinematic = "cinematics/alien/gorge/clog_spawn_kodiak.cinematic"},
        } 
    },
