...
function AmbientSound:StartPlaying()
    ...
    if not self.playing then
        ...
        self.soundEffectInstance:SetVolume(self.volume * Client.kAmbientVolume)
...
function AmbientSound:UpdateVolume()
    ...
    if self.soundEffectInstance and self.playing == true and self.soundEffectInstance:GetIsPlaying() then
        self.soundEffectInstance:SetVolume(self.volume * Client.kAmbientVolume)
    end
