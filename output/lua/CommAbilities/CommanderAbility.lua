...
function CommanderAbility:OnFilteredCinematicOptionChanged()

    local cinematic = self:GetRepeatCinematic()
    if cinematic and self.repeatingEffect then
        self.repeatingEffect:SetCinematic(FilterCinematicName(cinematic))
    end
...
function CommanderAbility:CreateStartEffect() --FIXME Refactor to utilize EffectsManager
    ...
    if Client then
        ...
        if cinematic ~= nil then
            ...
            effect:SetCinematic(FilterCinematicName(cinematic))
