...
local function Thunderdome_OnUserStatsAndItemsRefreshed()
    GetGlobalEventDispatcher():FireEvent("OnUserStatsAndItemsRefreshed")
end
Thunderdome_AddListener(kThunderdomeEvents.OnUserStatsAndItemsRefreshed, Thunderdome_OnUserStatsAndItemsRefreshed)
...
function SendOnGUIObjectRightClicked(obj)
    GetGlobalEventDispatcher():FireEvent("OnGUIObjectRightClicked", obj)
end
