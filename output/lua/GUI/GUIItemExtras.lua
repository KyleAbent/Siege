...
g_GUIItemPropertyGetters =
{
    ...
    AlignsToPixels                  = GUIItem.GetAlignsToPixels,
...
g_GUIItemPropertySetters =
{
    ...
    AlignsToPixels                  = GUIItem.SetAlignsToPixels,
...
-- Override GUIItem.SetTextureCoordinates to accept either a list of 4 numbers like usual (x0, y0,
-- x1, y1) or an array-table of 4 values.
local old_GUIItem_SetTextureCoordinates = GUIItem.SetTextureCoordinates
GUIItem.SetTextureCoordinates = function(self, p1, p2, p3, p4)
    if type(p1) == "table" then
        return (old_GUIItem_SetTextureCoordinates(self, p1[1], p1[2], p1[3], p1[4]))
    elseif type(p1) == "number" then
        return (old_GUIItem_SetTextureCoordinates(self, p1, p2, p3, p4))
    end
end

-- Override GUIItem.SetTexturePixelCoordinates to accept either a list of 4 numbers like usual (x0,
-- y0, x1, y1) or an array-table of 4 values.
local old_GUIItem_SetTexturePixelCoordinates = GUIItem.SetTexturePixelCoordinates
GUIItem.SetTexturePixelCoordinates = function(self, p1, p2, p3, p4)
    if type(p1) == "table" then
        return (old_GUIItem_SetTexturePixelCoordinates(self, p1[1], p1[2], p1[3], p1[4]))
    elseif type(p1) == "number" then
        return (old_GUIItem_SetTexturePixelCoordinates(self, p1, p2, p3, p4))
    end
end
