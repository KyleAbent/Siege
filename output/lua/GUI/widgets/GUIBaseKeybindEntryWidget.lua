...
function GUIBaseKeybindEntryWidget:OnMouseRightRelease()

    -- Allow mouse button to be used as a key.
    if self:GetEditing() then
        self:OnKey(InputKey.MouseButton1, true)
        return true
    end

end

local function SharedMouseClick(self, mouseButtonInputKey)
    ...
    self:OnKey(mouseButtonInputKey, true)
    
end

function GUIBaseKeybindEntryWidget:OnMouseClick()
    SharedMouseClick(self, InputKey.MouseButton0)
end

function GUIBaseKeybindEntryWidget:OnMouseRightClick()
    SharedMouseClick(self, InputKey.MouseButton1)
end
...
function GUIBaseKeybindEntryWidget:OnOutsideRightClick()
    SharedMouseClick(self, InputKey.MouseButton1)
end
