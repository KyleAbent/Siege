...
function GUITextInputWidget:SetupVisuals()
    ...
    self.displayText = CreateGUIObject("displayText", self.displayClass, self)
...
function GUITextInputWidget:Initialize(params, errorDepth)
    ...
    if params.displayClass then
        RequireClassIsa("GUIObject", params.displayClass, "params.displayClass", errorDepth)
    end

    self.displayClass = params.displayClass or GUIText
    ...
    self:HookEvent(self, "OnBottomPaddingChanged", UpdateDisplayedText)
