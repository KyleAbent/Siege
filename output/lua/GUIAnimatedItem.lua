...
function GUIAnimatedItem:SetOptionFlag(flag)
    self.guiItem:SetOptionFlag(flag)
end

function GUIAnimatedItem:GetScaledSize()
    return self.guiItem:GetScaledSize()
end

function GUIAnimatedItem:GetAbsoluteScale()
    return self.guiItem:GetAbsoluteScale()
end
...
function GUIAnimatedItem:SetHotSpot(hotspotVector)
    self.guiItem:SetHotSpot(hotspotVector)
end

-- Sets the GUIAnimatedItem's size to the texture dimensions.  You can optionally provide a (uniform)
-- scale factor.
function GUIAnimatedItem:SetSizeFromTexture(mult)
    self:SetSize(Vector(self.guiItem:GetTextureWidth() * (mult or 1), self.guiItem:GetTextureHeight() * (mult or 1), 0))
end

function GUIAnimatedItem:GetTextureWidth()
    return self.guiItem:GetTextureWidth()
end

function GUIAnimatedItem:GetTextureHeight()
    return self.guiItem:GetTextureHeight()
end
