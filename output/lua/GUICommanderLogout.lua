...
function GUICommanderLogout:Initialize()
    ...
    if CommanderUI_IsAlienCommander() then
        self.background:SetTexture(ConditionalValue(minimal, "ui/transparent.dds", GUICommanderLogout.kLogoutAlienTextureName))
    else
        self.background:SetTexture(ConditionalValue(minimal, "ui/transparent.dds", GUICommanderLogout.kLogoutMarineTextureName))
    end
