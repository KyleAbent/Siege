...
function GUICommanderTooltip:InitializeBackground()
    ...
    self.backgroundTop:SetTexture(ConditionalValue(minimal, "ui/transparent.dds", self.textureName))
    ...
    self.backgroundCenter:SetTexture(ConditionalValue(minimal, "ui/transparent.dds", self.textureName))
    ...
    self.backgroundBottom:SetTexture(ConditionalValue(minimal, "ui/transparent.dds", self.textureName))
