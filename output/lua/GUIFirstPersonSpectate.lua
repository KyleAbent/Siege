...
function GUIFirstPersonSpectate:SendKeyEvent(key, down)
    ...
    local isBotDebugging = gBotDebugWindow ~= nil -- Client side check, ServerClient isn't available on Clients...

    -- Completely disable changing spectator mode via normal controls
    -- when debugging bots. Should only be controlled via UI if this is
    -- the case.
