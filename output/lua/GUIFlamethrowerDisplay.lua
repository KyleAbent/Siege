...
local kTextures =
{
    "ui/FlamethrowerDisplay.dds",  -- normal
    "ui/FlamethrowerDisplay4.dds", -- kodiak
    "ui/FlamethrowerDisplay3.dds", -- tundra
    "ui/FlamethrowerDisplay1.dds", -- forge
    "ui/FlamethrowerDisplay2.dds", -- sandstorm
    "ui/FlamethrowerDisplay5.dds", -- chroma
}
