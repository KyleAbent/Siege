...
--kGrenadeLauncherVariants = enum({ "normal", "sandstorm", "tundra", "forge", "kodiak", "chroma" })
local kTextures = 
{
    "models/marine/grenadelauncher/grenade_launcher_view_display.dds",
    "models/marine/grenadelauncher/grenade_launcher_view_display1.dds",    --sandstorm
    "models/marine/grenadelauncher/grenade_launcher_view_display_tundra.dds",
    "models/marine/grenadelauncher/grenade_launcher_forge_view_display.dds",
    "models/marine/grenadelauncher/grenade_launcher_view_display_kodiak.dds",
    "models/marine/grenadelauncher/grenade_launcher_view_display_chroma.dds",
}
