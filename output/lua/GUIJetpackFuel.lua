...
function GUIJetpackFuel:Initialize()    
    ...
    local yPos = -GUIJetpackFuel.kBackgroundHeight / 2 + GUIJetpackFuel.kBackgroundOffsetY
    local xOffsetMultiplier = ConditionalValue(GetAdvancedOption("hudbars_m") == 2, 2.5, 1)
    local xPos = GUIJetpackFuel.kBackgroundWidth / 2 + GUIJetpackFuel.kBackgroundOffsetX * xOffsetMultiplier
