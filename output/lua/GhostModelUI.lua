...
function GhostModelUI_GetAlternativeGhostGuides()
    return gAlternativeGhostGuides
end
...
local function OnUpdateRenderGhostModel()
    ...
    if showGhostModel and techId then
        ...
        if gLastTechId ~= techId then
            gLastTechId = techId
            gAlternativeGhostGuides = techId and LookupTechData(techId, kVisualRange, nil) ~= nil
        end
