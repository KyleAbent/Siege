...
function NanoShieldMixin:ComputeDamageOverrideMixin(attacker, damage, damageType, hitPoint, overshieldDamage)

    if self.nanoShielded == true then
        return damage * kNanoShieldDamageReductionDamage, overshieldDamage
    end
