...
PhysicsMask = enum
{
    ...
    AIEnclosure = CreateMaskIncludingGroups(PhysicsGroup.DefaultGroup,
                                            PhysicsGroup.CollisionGeometryGroup,
                                            PhysicsGroup.CommanderPropsGroup),

    ExploreTargets = CreateMaskIncludingGroups(PhysicsGroup.BigStructuresGroup,
                                               PhysicsGroup.AttachClassGroup),
    ...
    -- For alien wall jumping
    AllButPCsAndWebs = CreateMaskExcludingGroups(PhysicsGroup.PlayerControllersGroup,
                                                 PhysicsGroup.BigPlayerControllersGroup,
                                                 PhysicsGroup.PathingGroup,
                                                 PhysicsGroup.MarinePlayerGroup,
                                                 PhysicsGroup.WebsGroup),
    ...
    GLGrenadeGroup = CreateMaskExcludingGroups(PhysicsGroup.CollisionGeometryGroup,
                                               PhysicsGroup.RagdollGroup,
                                               PhysicsGroup.ProjectileGroup,
                                               PhysicsGroup.WeaponGroup,
                                               PhysicsGroup.DroppedWeaponGroup,
