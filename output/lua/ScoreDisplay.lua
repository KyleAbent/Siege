...
local kScoreEnabled = GetAdvancedOption("score")
local kAssistsEnabled = GetAdvancedOption("assists")

function ScoreDisplayUI_SetScoreEnabled(enabled)
    kScoreEnabled = enabled
end

function ScoreDisplayUI_SetAssistsEnabled(enabled)
    kAssistsEnabled = enabled
end
...
function ScoreDisplayUI_SetNewScore(score, res, wasKill)
    ...
    if (wasKill and kScoreEnabled) or (not wasKill and kAssistsEnabled) then
