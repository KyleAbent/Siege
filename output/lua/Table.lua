...
Script.Load("lua/container/Set.lua")
Script.Load("lua/container/Queue.lua")
Script.Load("lua/container/Map.lua")
...
-- Replace the embedded bytecode version that failing for some reason
