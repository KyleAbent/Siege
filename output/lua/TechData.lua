...
-- Localizable string for reserach notification display name
kTechDataResearchName                   = "researchdisplayname"
...
kTechDataResearchIgnoreCompleteAlert    = "ignoreresearchcompletealert"
...
function BuildTechData()
    ...
    local techData =
    {
...

        {
            ...
            [kTechDataObstacleRadius] = 0.75,   --Just in case these ever get added to nav-mesh, which would _potentially_ be a huge help to Bots
        },
