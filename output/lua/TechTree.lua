...
function TechTree:Initialize()
    ...
    self.techIdList = {} -- list of available techids (used for iterating over techtree
    ...
    if Server then
        ...
        self.inProgressResearch = IterableDict()
        self.inProgressInstances = IterableDict()
...
function GetIsTechResearching(callingEntity, techId)
    ...
    local entityTeamNumber = HasMixin(callingEntity, "Team") and callingEntity:GetTeamNumber() or kTeamInvalid
