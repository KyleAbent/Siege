...
function TrailCinematic:SetCinematicNames(cinematicNames)
    ...
    local filteredCinematicNames = {}
    for _, cinName in ipairs(cinematicNames) do
        table.insert(filteredCinematicNames, FilterCinematicName(cinName))
    end

    self.cinematicNames = filteredCinematicNames
end
...
function TrailCinematic:SetFadeOutCinematicNames(cinematicNames)
    ...
    self.fadeOutCinematicNames = filteredCinematicNames
end    
