...
function Flame:GetTechId()
    return kTechId.Flamethrower -- For damage scaling.
end

function Flame:GetIsAffectedByWeaponUpgrades()
    return true
end
...
function Flame:OnInitialized()
    ...
    elseif Client then
        ...
        self.fireEffect:SetCinematic(FilterCinematicName(cinematicName))
