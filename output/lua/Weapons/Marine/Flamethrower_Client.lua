...
function Flamethrower:OnFilteredCinematicOptionChanged()

    if self.pilotCinematic then
        self.pilotCinematic:SetCinematic(FilterCinematicName(kPilotCinematicName))
    end

    self.effectLoaded = nil -- Reload trail cinematic.
end
