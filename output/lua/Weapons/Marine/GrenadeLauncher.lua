...
function GrenadeLauncher:ShootGrenade(player)
    ...
    if Server or (Client and Client.GetIsControllingPlayer()) then
        ...
        player:CreatePredictedProjectile("Grenade", startPoint, direction * GrenadeLauncher.kGrenadeSpeed,
                                         GrenadeLauncher.kGrenadeBounce, GrenadeLauncher.kGrenadeFriction,
