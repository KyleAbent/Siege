...
gBotDebug:AddBoolean("target_prio", false)
gBotDebug:AddBoolean("target_prio_urgency", false) -- very spammy, outputs attack urgency function
gBotDebug:AddBoolean("com_m_actions", false) -- very spammy, outputs marine commander actions
...
Event.Hook("Console_bot_hotload", function()
    Log("Reloading Bot Data files...")
        Script.Load("lua/bots/MarineBrain_Data.lua", true)
        --TODO Add Minigun / Railgun
        Script.Load("lua/bots/GorgeBrain_Data.lua", true)
        Script.Load("lua/bots/SkulkBrain_Data.lua", true)
        Script.Load("lua/bots/LerkBrain_Data.lua", true)
        Script.Load("lua/bots/FadeBrain_Data.lua", true)
        Script.Load("lua/bots/OnosBrain_Data.lua", true)
