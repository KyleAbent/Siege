...
kMarineBrainActions =
{
    ...
    function(bot, brain, marine)
        ...
        if weapon ~= nil and weapon:isa("ClipWeapon") and s:Get("ammoFraction") > 0 then
            ...
            if threat ~= nil and threat.distance < 15 and ( s:Get("clipFraction") > 0.0 or s:Get('pistolClipFraction') > 0 ) then
    ...
    function(bot, brain, marine)
        ...
        if exo and not HasGoodWeapon(marine) and (exo:GetOwner() == nil or exo:GetOwner() == marine:GetId() ) then
            weight = GetMarineActionBaselineWeight( kMarineBrainActionTypes.MountExosuit )
        end
