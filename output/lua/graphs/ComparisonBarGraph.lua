...
function ComparisonBarGraph:OnResolutionChanged(_, _, _, _)
...
function ComparisonBarGraph:SetLeftText(text)
    self.leftText = text
    self:refreshText()
end

function ComparisonBarGraph:SetRightText(text)
    self.rightText = text
    self:refreshText()
end
...
function ComparisonBarGraph:SetStencilFunc(stencilFunc)
...
function ComparisonBarGraph:SetValuesAreTime(bool)
