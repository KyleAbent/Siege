...
function GUIMainMenu:CreateProfile()
    ...
    self.avatar:SetBackgroundTexture(GetLocalAvatarTextureName())
...
local function InitOptions(self)
    ...
    local musicVol = Client.GetOptionInteger("musicVolume", 80) / 100
...
local function SaveOptions(mainMenu)
    ...
    Client.SetOptionInteger("hudmode", hudmode == Locale.ResolveString("HIGH") and kHUDMode.Full or (hudmode == Locale.ResolveString("LOW") and kHUDMode.Low or kHUDMode.Minimal))
    Client.SetOptionInteger("graphics/lightQuality", lightQuality)
