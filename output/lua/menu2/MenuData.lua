...
MenuData.Config.OptionsMenu.General = MenuData.CreateExtendedOptionsLayout
{
    checksChildren =
    {
        -- SHOW HINTS
    ...
    regularChildren =
    {
            ...
            children =
            {
                ...
                -- NICKNAME
                {
                    ...
                    postInit =
                    {
                        ...
                        function(self)
                            self:HookEvent(self, "OnValueChanged", function(self2)
                                -- Only update when reverting changes, not on every character change during edit
                                if not self:GetEditing() then
                                    GetLocalPlayerProfileData():SetPlayerName(self2:GetValue())
                                end
                            end)
                        end,
        ...
        -- FOV GROUP
        {
            ...
            children =
            {
                -- ENABLE/DISABLE TEAM SPECIFIC FOV
                {
                    name = "fovTeamSpecific",
                    class = OP_TT_Checkbox,
                    params =
                    {
                        useResetButton = true,
                        optionPath = "CHUD_FOVPerTeam",
                        optionType = "bool",
                        default = false,

                        immediateUpdate = function()
                            if ApplyFOVOptions then
                                ApplyFOVOptions()
                            end
                        end,

                        tooltip = Locale.ResolveString("OPTION_PERTEAM_FOV_TOOLTIP")
                    },

                    properties =
                    {
                        {"Label", Locale.ResolveString("OPTION_PERTEAM_FOV")},
                    },
                },
                ...
                -- FOV ADJUST
                {
                    ...
                    {
                        function(self)
                            self:HookEvent(GetOptionsMenu():GetOptionWidget("fovTeamSpecific"), "OnValueChanged",
                                    function(self, value)
                                        self:SetExpanded(not value)
                                    end)

                            self:SetExpanded(not GetOptionsMenu():GetOptionWidget("fovTeamSpecific"):GetValue())
                        end,
                    }
                },
                ...
                -- FOV MARINE TEAM
                {
                    ...
                    params =
                    {
                        ...
                        tooltip = Locale.ResolveString("OPTION_FOV_MARINE_TOOLTIP")
                    },

                    properties =
                    {
                        {"Label", Locale.ResolveString("OPTION_FOV_MARINE")..": "},
                    },
                    ...
                    postInit =
                    {
                        function(self)
                            ...
                            self:SetExpanded(GetOptionsMenu():GetOptionWidget("fovTeamSpecific"):GetValue())
                        end,
                    }
                },
                ...
                -- FOV ALIEN TEAM
                {
                    ...
                    params =
                    {
                        ...
                        tooltip = Locale.ResolveString("OPTION_FOV_ALIEN_TOOLTIP")
                    },

                    properties =
                    {
                        {"Label", Locale.ResolveString("OPTION_FOV_ALIEN")..": "},
                    },
            ...
            params =
            {
                ...
                immediateUpdate = function(self)
                    if Client and Client.SetHudDetail then
                        ...
                        GetMainMenu():UpdateGridVisiblity()
                    end
                end,
                ...
                {"Choices",
                    {
                        ...
                        { value = 3, displayString = Locale.ResolveString("MINIMAL") },
                    }
                },
            },
        },
        ...
        -- MENU MUSIC
        {
            ...
            params =
            {
                ...
                optionType = "string",
                default = "random",
                autoRestart = true,     --FIXME Why does this need to restart the MainVM? it should not
            },
    ...
    {
        {
            name = "openControlsButton",
            class = GUIMenuButton,

            properties =
            {
                {"Label", Locale.ResolveString("CONTROLS")}
            },
            ...
            postInit = function(createdObj)
                ...
                function()
                    GetOptionsMenu():SetSubScreenActive("Controls", false)
                end)
...
MenuData.Config.OptionsMenu.Controls = MenuData.CreateControlsLayout
{
    ...
    leftChildren =
    {
        ...
        { -- INVERT MOUSE
            ...
            {
                useResetButton = true,
                optionPath = kInvertedMouseOptionsKey,
                optionType = "bool",
                default = false,
        ...
        { -- TEAM SPECIFIC MOUSE SENSITIVITY ENABLED/DISABLED
            name = "perTeamSensitivity",
            class = OP_TT_Checkbox,
            params =
            {
                useResetButton = true,
                optionPath = "CHUD_SensitivityPerTeam",
                optionType = "bool",
                default = false,

                immediateUpdate = function()

                    if ApplySensitivityOptions then
                        ApplySensitivityOptions()
                    end

                end,

                tooltip = Locale.ResolveString("OPTION_PERTEAM_SENSITIVITY_TOOLTIP")
            },

            properties =
            {
                {"Label", Locale.ResolveString("OPTION_PERTEAM_SENSITIVITY")},
            },
        },

        { -- LIFEFORM SPECIFIC MOUSE SENSITIVITY ENABLED/DISABLED
            name = "perLifeformSensitivity",
            class = OP_TT_Expandable_Checkbox,
            params =
            {
                useResetButton = true,
                optionPath = "CHUD_SensitivityPerLifeform",
                optionType = "bool",
                default = false,
                ...
                tooltip = Locale.ResolveString("OPTION_PERLIFEFORM_SENSITIVITY_TOOLTIP"),
            },

            properties =
            {
                {"Label", Locale.ResolveString("OPTION_PERLIFEFORM_SENSITIVITY")},
            },

            postInit =
            {
                function(self)
                    self:HookEvent(GetOptionsMenu():GetOptionWidget("perTeamSensitivity"), "OnValueChanged",
                            function(self, value)
                                self:SetExpanded(value)
                            end)
                    self:SetExpanded(GetOptionsMenu():GetOptionWidget("perTeamSensitivity"):GetValue())
                end,
            }
        },
        ...
        { -- MOUSE SENSITIVITY
            ...
            {
                useResetButton = true,
                optionPath = "input/mouse/sensitivity",
                optionType = "float",
                default = kDefaultSensitivity,
                ...
                tooltip = Locale.ResolveString("MOUSE_SENSITIVITY_TOOLTIP")
            },
            ...
            postInit =
            {
                function(self)
                    ...
                    -- Hide regular mouse sensitivity if per team sens is enabled.
                    self:HookEvent(GetOptionsMenu():GetOptionWidget("perTeamSensitivity"), "OnValueChanged",
                            function(self, value)
                                self:SetExpanded(not value)
                            end)

                    self:SetExpanded(not GetOptionsMenu():GetOptionWidget("perTeamSensitivity"):GetValue())
                end
            },

        },

        { -- MARINE MOUSE SENSITIVITY
            name = "marineSensitivity",
            class = OP_TT_Expandable_Number,
            params =
            {
                useResetButton = true,
                optionPath = "CHUD_Sensitivity_M",
                optionType = "float",
                default = kDefaultSensitivity,
                ...
                tooltip = Locale.ResolveString("OPTION_MARINETEAM_SENSITIVITY_TOOLTIP")
            },

            properties =
            {
                {"Label", Locale.ResolveString("OPTION_MARINETEAM_SENSITIVITY")},
            },
        ...
        { -- ALIEN MOUSE SENSITIVITY
            name = "alienSensitivity",
            class = OP_TT_Expandable_Number,
            params =
            {
                useResetButton = true,
                optionPath = "CHUD_Sensitivity_A",
                optionType = "float",
                default = kDefaultSensitivity,
                ...
                tooltip = Locale.ResolveString("OPTION_ALEINTEAM_SENSITIVITY_TOOLTIP")
            },

            properties =
            {
                {"Label", Locale.ResolveString("OPTION_ALEINTEAM_SENSITIVITY")},
            },
                ...
                function(self)
                    self:HookEvent(GetOptionsMenu():GetOptionWidget("perTeamSensitivity"), "OnValueChanged",
                            function(self, value)
                                ...
                                local perLifeForm = GetOptionsMenu():GetOptionWidget("perLifeformSensitivity"):GetValue()
                                self:SetExpanded(value and not perLifeForm)
                            end)

                    self:HookEvent(GetOptionsMenu():GetOptionWidget("perLifeformSensitivity"), "OnValueChanged",
                            function(self, value)

                                local perTeam = GetOptionsMenu():GetOptionWidget("perTeamSensitivity"):GetValue()
                                self:SetExpanded(perTeam and not value)
                            end)

                    local perLifeForm = GetOptionsMenu():GetOptionWidget("perLifeformSensitivity"):GetValue()
                    self:SetExpanded(GetOptionsMenu():GetOptionWidget("perTeamSensitivity"):GetValue() and not perLifeForm)
                end,
            },
        },

        { -- SKULK MOUSE SENSITIVITY
            name = "skulkSensitivity",
            class = OP_TT_Expandable_Number,
            params =
            {
                useResetButton = true,
                optionPath = "CHUD_Sensitivity_Skulk",
                optionType = "float",
                default = kDefaultSensitivity,
                ...
                tooltip = Locale.ResolveString("OPTION_SKULK_SENSITIVITY_TOOLTIP")
            },

            properties =
            {
                {"Label", Locale.ResolveString("OPTION_SKULK_SENSITIVITY")},
            },
            ...
            postInit =
            {
                function(self)
                    self:HookEvent(GetOptionsMenu():GetOptionWidget("perLifeformSensitivity"), "OnValueChanged",
                            function(self, value)
                                local perTeam = GetOptionsMenu():GetOptionWidget("perTeamSensitivity"):GetValue()
                                self:SetExpanded(value and perTeam)
                            end)

                    self:HookEvent(GetOptionsMenu():GetOptionWidget("perTeamSensitivity"), "OnValueChanged",
                            function(self, value)
                                local perLifeform = GetOptionsMenu():GetOptionWidget("perLifeformSensitivity"):GetValue()
                                self:SetExpanded(value and perLifeform)
                            end)

                    local perTeam = GetOptionsMenu():GetOptionWidget("perTeamSensitivity"):GetValue()
                    self:SetExpanded(GetOptionsMenu():GetOptionWidget("perLifeformSensitivity"):GetValue() and perTeam)
                end,
            },
        },

        { -- GORGE MOUSE SENSITIVITY
            name = "gorgeSensitivity",
            class = OP_TT_Expandable_Number,
            params =
            {
                useResetButton = true,
                optionPath = "CHUD_Sensitivity_Gorge",
                optionType = "float",
                default = kDefaultSensitivity,
                ...
                tooltip = Locale.ResolveString("OPTION_GORGE_SENSITIVITY_TOOLTIP")
            },

            properties =
            {
                {"Label", Locale.ResolveString("OPTION_GORGE_SENSITIVITY")},
            },
        ...
        { -- LERK MOUSE SENSITIVITY
            name = "lerkSensitivity",
            class = OP_TT_Expandable_Number,
            params =
            {
                useResetButton = true,
                optionPath = "CHUD_Sensitivity_Lerk",
                optionType = "float",
                default = kDefaultSensitivity,
                ...
                tooltip = Locale.ResolveString("OPTION_LERK_SENSITIVITY_TOOLTIP")
            },

            properties =
            {
                {"Label", Locale.ResolveString("OPTION_LERK_SENSITIVITY")},
            },
        ...
        { -- FADE MOUSE SENSITIVITY
            name = "fadeSensitivity",
            class = OP_TT_Expandable_Number,
            params =
            {
                useResetButton = true,
                optionPath = "CHUD_Sensitivity_Fade",
                optionType = "float",
                default = kDefaultSensitivity,
                ...
                tooltip = Locale.ResolveString("OPTION_FADE_SENSITIVITY_TOOLTIP")
            },

            properties =
            {
                {"Label", Locale.ResolveString("OPTION_FADE_SENSITIVITY")},
            },
        ...
        { -- ONOS MOUSE SENSITIVITY
            name = "onosSensitivity",
            class = OP_TT_Expandable_Number,
            params =
            {
                useResetButton = true,
                optionPath = "CHUD_Sensitivity_Onos",
                optionType = "float",
                default = kDefaultSensitivity,
                ...
                tooltip = Locale.ResolveString("OPTION_ONOS_SENSITIVITY_TOOLTIP")
            },

            properties =
            {
                {"Label", Locale.ResolveString("OPTION_ONOS_SENSITIVITY")},
            },
        ...
        MenuData.CreateExpandableKeybindGroup
        {
            ...
            children =
            {
                ...
                { -- PREVIOUS WEAPON
                    ...
                    params =
                    {
                        optionPath = "input/SelectPrevWeapon",
                        optionType = "string",
        ...
        MenuData.CreateExpandableKeybindGroup
        {
            ...
            children =
            {
                ...
                { -- MARINE TEAM
                    ...
                    properties =
                    {
                        {"Label", Locale.ResolveString("JOIN_MARINES")},
                    },
                },
                ...
                { -- ALIEN TEAM
                    ...
                    properties =
                    {
                        {"Label", Locale.ResolveString("JOIN_ALIENS")},
                    },
                },

                { -- SPECTATOR
                    name = "goToSpectatorTeam",
                    class = OP_Keybind,
                    params =
                    {
                        optionPath = "input/JoinSpectate",
                        optionType = "string",
                        default = "F7",
                    ...
                    properties =
                    {
                        {"Label", Locale.ResolveString("JOIN_SPECTATE")},
                    },
                },
                ...
                { -- PROFILE PAUSE
                    ...
                    params =
                    {
                        optionPath = "input/ProfilePause",
                        optionType = "string",
                        default = "Space",
                        
                        -- Used to be hard-coded to space long ago, which conflicted with jumping.
                        -- since this is a little-used feature, I'm putting this behind its own
                        -- group so that it never conflicts with anything.
                        bindGroup = "profile",

                        tooltip = Locale.ResolveString("PROFILE_PAUSE_TOOLTIP"),
                    },
                    properties =
                    {
                        {"Label", Locale.ResolveString("PROFILE_PAUSE")},
                    },
                },
            },
        },
...
MenuData.Config.OptionsMenu.Graphics = MenuData.CreateDefaultOptionsLayout
{
    checksChildren =
    {
        ...
        -- AMBIENT OCCLUSION
        {
            ...
            {
                useResetButton = true,
                optionPath = kAmbientOcclusionOptionsKey,
                optionType = "bool",
                default = true,
                immediateUpdate = function(self)
                    Client.SetRenderSetting("ambient_occlusion", tostring(self:GetValue()))
                end,
    ...
    regularChildren =
    {
        ...
        -- MAX FPS
        {
            ...
            params =
            {
                ...
                tooltip = Locale.ResolveString("MAXFPS_TOOLTIP"),
            },

            properties =
            {
                {"Label", Locale.ResolveString("MAX_FPS")..": "},
            },
        ...
        -- TEXTURE QUALITY
        {
            ...
            params =
            {
                ...
                default = 2,
                immediateUpdate = function(self)
                    local oldValue = Client.GetOptionInteger("graphics/display/quality", 2)
                    local value = self:GetValue()
            ...
            params =
            {
                ...
                immediateUpdate = function(self)
                    ...
                    if Lights_UpdateLightMode then
                        local before = Client.GetOptionInteger("graphics/lightQuality", 2)
                ...
                {"Choices",
                    {
                        { value = 2, displayString = Locale.ResolveString("HIGH") },
                        { value = 1, displayString = Locale.ResolveString("LOW") },
                        { value = 0, displayString = Locale.ResolveString("MINIMAL") },
                    },
                },
            },
        },
            ...
            children =
            {
                ...
                -- ATMOSPHERICS DENSITY
                {
                    ...
                    params =
                    {
                        ...
                        optionType = "float",
                        default = kDefaultLightsAtmoDensity,
                        immediateUpdate = function(self)
                            ...
                            local oldValue = Client.GetOptionFloat("graphics/atmospheric-density", kDefaultLightsAtmoDensity)
                            local value = self:GetValue()
        ...
        -- FOG
        {
            ...
            {
                useResetButton = true,
                optionPath = GetFogOptionPath(),
                optionType = GetFogOptionType(),
                default = GetFogDefaultValue(),
                immediateUpdate = UpdateFogVisibility,
        
                tooltip = Locale.ResolveString("OPTION_FOG_TOOLTIP"),
            },
    
            properties =
            {
                { "Value", GetFogOptionValue(), },
                { "Label", Locale.ResolveString("FOG"), },
                { "Choices",
                    {
                        { value = "high", displayString = Locale.ResolveString("HIGH"), },
                        { value = "low", displayString = Locale.ResolveString("LOW"), },
        ...
        --Color Blind Modes
        {
            ...
            {
                useResetButton = true,
                optionPath = kColorBlindOptionsKey,
                optionType = "int",
                default = 0,
                immediateUpdate = function(self)
                    local value = self:GetValue()
                    Client.SetRenderSetting("colorblind_mode",value)
                end,
            },
            properties =
            {
                { "Label", Locale.ResolveString("COLORBLIND_MODE"), },
                { "Choices",
                    {
                        { value = 0, displayString = Locale.ResolveString("OFF"), },
                        { value = 1, displayString = Locale.ResolveString("COLORBLIND_PROTANOPIA"), },
                        { value = 2, displayString = Locale.ResolveString("COLORBLIND_DEUTERANOPIA"), },
                        { value = 3, displayString = Locale.ResolveString("COLORBLIND_TRITANOPIA"), },
                    },
                },
            },
...
MenuData.Config.OptionsMenu.Sound = MenuData.CreateDefaultOptionsLayout
{
    ...
    regularChildren =
    {
        ...
        -- AMBIENT VOLUME
        {
            ...
            {
                useResetButton = true,
                optionPath = "ambientVolume",
                optionType = "int",
                default = 100,

                immediateUpdate = function(self)

                    if Client and decoda_name == "Client" then

                        local value = self:GetValue()
                        Client.kAmbientVolume = (value / 100)

                        for a = 1, #Client.ambientSoundList do
                            Client.ambientSoundList[a]:UpdateVolume()
                        end
                    end
                ...
                tooltip = Locale.ResolveString("AMBIENT_VOLUME_TOOLTIP"),
            },

            properties =
            {
                {"Label", Locale.ResolveString("AMBIENT_VOLUME")..": "},
            },
        },
        ...
        -- HIT-SOUND PITCH
        {
            ...
            params =
            {
                ...
                tooltip = Locale.ResolveString("HIT_SOUND_PITCH_TOOLTIP"),
            ...
            properties =
            {
                {"Label", Locale.ResolveString("HIT_SOUND_PITCH")..": "},
            },
            ...
            postInit =
            {
                function(self)
                    self:HookEvent(self, "OnDragEnd", MenuData.PreviewHitSound)
                    self:HookEvent(self, "OnJump", MenuData.PreviewHitSound)
                    self:HookEvent(self, "OnEditAccepted", MenuData.PreviewHitSound)
                end,
            },
        },
    },
...
MenuData.Config.OptionsMenu.Advanced =
{
    name = "advancedCategoryDisplayBox",
    class = GUIMenuCategoryDisplayBox,
    postInit =
    {
        ---- Add field to options menu, for easy access.
        function(self) GetOptionsMenu().advancedCategoryDisplayBox = self end,
...
kStartServer_MapMod = "start-server/map-mod"
kStartServer_LoadHotfixMods = "start-server/load-hotfix-mods"
...
kStartServer_MaxPlayerLimit = 20
...
MenuData.StartServerMenu =
{
    ...
    children =
    {
        ...
        { -- Map
            ...
            params =
            {
                ignoreDefaultAsterisk = true,
                label = Locale.ResolveString("SERVERBROWSER_MAP"),
                alternateSetter = MenuData.SetListenServerMap,
                alternateGetter = MenuData.GetListenServerMap,
            },
            postInit = 
            {
                function(self)
        ...
        { -- Player Limit
            ...
            params =
            {
                ...
                minValue = 1,
                maxValue = kStartServer_MaxPlayerLimit,
                decimalPlaces = 0,
        ...
        { -- Add Bots
            ...
            params =
            {
                label = Locale.ResolveString("SERVERBROWSER_CREATE_LOAD_HOTFIXM_MODS"),
                optionPath = kStartServer_LoadHotfixMods,
                optionType = "bool",
                default = true,
            }
        },
