...
{
    {
        ...
        members = 
        {
            ...
            "Chris \"Ironhorse\" Gates (QA Lead and VFX)",
            ...
            "Amanda \"Rantology\" Diaz (Art Director)",
			"Darrel \"Salads\" Gentry (Programmer)",
            "Webster \"AxtelSturnclaw\" Sheets (Programmer)"
        }
    },
        ...
        {
			{
                ...
                members =
                {
					...
					"Paul \"Sinakuwolf\" Wolfe (Environment Art)",
					"Ballboy (QA lead)",
					"Terence (Linux Assistance)",
					"Markus \"Mephilles\" Grywnow (Level Design)",
					"Vlaad (Modeling and Animation)",
					"Katzen (Programming)",
					"Loki (Level Design)",
					"Psyk (Level Design and Map Fixes)",
					"Shrimm (Level Design and Map Fixes)",
					"Kash (Level Design and Map Fixes)",
					"Matt \"Zavaro\" Allbright (Level design and Map Fixes)",
					"Zachary \"Thesaltyseacaptain\" Weiss (Map fixes)",
                }
            },
        ...
        {
            {
                ...
                members =
                {
                    ...
                    "Toughsox",
                    "xtcmen",
                    "Paul \"Sinakuwolf\" Wolfe",
                    "Jamie \"Kash\" Sloan",
                    "Kevin \"Steelcap\" Kicklighter",
                    "Stephen \"Uncle Bo\" Ryan",
                    "Alex \"TriggerHappyBro\" Hollifield",
                    "Jon \"Trilantis\" Voss",
                    "Charlotte \"CharMomone\" Lewis",
                    "Ty \"Noky\" Emmert",
                    "Zachary \"Thesaltyseacaptain\" Weiss",
                }
            }
        }
    },
...

    {
        ...
        members =
        {
            ...
            "Jason Ruymen",
            "Team Archaea",
            "Matt \"Zavaro\" Allbright (B.M.A.C. Voice acting)",
            "Carl McGahan (B.M.A.C. Voice acting)",
            "Valve",
            "Humble Bundle",
