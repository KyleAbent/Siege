...
--
-- lua/menu2/NavBar/News/GUIMenuNewsFeedPullout.lua
--
--    Created by:   Trevor Harris (trevor@naturalselection2.com)
--
--    Bit at the bottom of the news feed used to open/close the feed.
--
...
function GUIMenuNewsFeedPullout:Initialize(params, errorDepth)
    ...
    {
        text = Locale.ResolveString("NEWS"),
    ...
    {
        text = Locale.ResolveString("CHANGELOG_TITLE"),
        font = MenuStyle.kOptionFont,
