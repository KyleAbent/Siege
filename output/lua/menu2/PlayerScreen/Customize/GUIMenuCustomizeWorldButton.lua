...
---@class GUIMenuCustomizeWorldButton : GUIShapedButton
...
function GUIMenuCustomizeWorldButton:ClearPressedCallback()
    self:UnHookEvent(self, "OnPressed", self.OnPressed)
end
...
function GUIMenuCustomizeWorldButton:SetMouseRightClickCallback( callback )
    ...
    self:HookEvent(self, "OnMouseRightClick", self.OnKey)
end
...
function GUIMenuCustomizeWorldButton:OnMouseRightRelease()
