...
function GUIMenuDropdownWidget:Initialize(params, errorDepth)
    ...
    local labelStartX = MenuStyle.kWidgetPadding
    ...
    --    self.resetButton:SetPosition(labelStartX, 0)
    ...
    --
    --    labelStartX = labelStartX + self.resetButton:GetSize().x + MenuStyle.kWidgetPadding
    --
    --end
    ...
    self.label:SetPosition(labelStartX, 0)
