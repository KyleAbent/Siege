...
function GUIMenuKeybindEntryWidgetSimple:OnMouseRightClick(double)
    baseClass.OnMouseRightClick(self, double)
    local result = self.keybind:OnMouseRightClick()
    return result
end
...
function GUIMenuKeybindEntryWidgetSimple:OnMouseRightRelease()
    baseClass.OnMouseRightRelease(self)
    local result = self.keybind:OnMouseRightRelease()
    return result
end
...
function GUIMenuKeybindEntryWidgetSimple:OnMouseRightUp()
    baseClass.OnMouseRightUp(self)
    local result = self.keybind:OnMouseRightUp()
    return result
end
...
function GUIMenuKeybindEntryWidgetSimple:OnOutsideRightClick()
    baseClass.OnOutsideRightClick(self)
    local result = self.keybind:OnOutsideRightClick()
    return result
end
