...
local function RecalculateSize(self)
    ...
    local numTextPadding = 4
    
    local combinedWidth = leftButtonTextWidth + rightButtonTextWidth + kButtonTextPadding*numTextPadding
    local newTotalWidth = math.max(minWidth, combinedWidth)
    local actualPadding = (newTotalWidth - leftButtonTextWidth - rightButtonTextWidth) * (1/numTextPadding)
