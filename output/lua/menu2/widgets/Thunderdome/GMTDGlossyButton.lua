...
---@class GMTDGlossyButton : GUIButton
...
GMTDGlossyButton = nil

class "GMTDGlossyButton" (baseClass)

GMTDGlossyButton:AddCompositeClassProperty("Label", "text", "Text")
...
function GMTDGlossyButton:Initialize(params, errorDepth)
