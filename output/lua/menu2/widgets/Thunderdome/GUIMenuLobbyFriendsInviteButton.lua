...
--
-- lua/menu2/widgets/Thunderdome/GUIMenuLobbyFriendsInviteButton.lua
--
...
---@class GUIMenuLobbyFriendsInviteButton : GUIButton
...
class "GUIMenuLobbyFriendsInviteButton" (baseClass)

GUIMenuLobbyFriendsInviteButton:AddCompositeClassProperty("Label", "text", "Text")
...
function GUIMenuLobbyFriendsInviteButton:Initialize(params, errorDepth)
    ...
    self.friendsList = CreateGUIObject("invitesPopup", GUIMenuFriendsInvitePrompt, nil,
    {
        title = "Invite Friends",   --change per context? e.g. GroupQueue -> Invite Two Friends
        buttonConfig = 
        { 
            {
                name = "ReturnToGame",
                params =
                {
                    label = Locale.ResolveString("TUTNAG_CLOSE"),
                },
