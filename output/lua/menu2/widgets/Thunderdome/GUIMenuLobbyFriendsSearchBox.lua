...
--
-- lua/menu2/widgets/Thunderdome/GUIMenuLobbyFriendsSearchBox.lua
--
--    Created by:       Trevor Harris (trevor@naturalselection2.com)
--    Hacked Up by:     Brock Gillespie (brock@naturalselection2.com)
--
...
---@class GUIMenuLobbyFriendsSearchBox : GUIObject
...
class "GUIMenuLobbyFriendsSearchBox" (baseClass)

-- See lua/GUI/wrappers/Editable.lua.
function GUIMenuLobbyFriendsSearchBox:GetIsTextInput()
    return true
end
...
GUIMenuLobbyFriendsSearchBox:AddCompositeClassProperty("Value", "entry")
...
function GUIMenuLobbyFriendsSearchBox:Initialize(params, errorDepth)
...
function GUIMenuLobbyFriendsSearchBox:_BeginEditing()
    self.entry:_BeginEditing()
end

function GUIMenuLobbyFriendsSearchBox:_EndEditing()
...
function GUIMenuLobbyFriendsSearchBox:GetValueString(value)
    local result = self.entry:GetValueString(value)
    return result
end

function GUIMenuLobbyFriendsSearchBox:OnMouseClick(double)
    baseClass.OnMouseClick(self, double)
    self.entry:OnMouseClick()
end

function GUIMenuLobbyFriendsSearchBox:OnMouseRelease()
    baseClass.OnMouseRelease(self)
    self.entry:OnMouseRelease()
end

function GUIMenuLobbyFriendsSearchBox:OnMouseUp()
    baseClass.OnMouseUp(self)
    self.entry:OnMouseUp()
end

function GUIMenuLobbyFriendsSearchBox:OnMouseEnter()
    baseClass.OnMouseEnter(self)
    self.entry:OnMouseEnter()
end

function GUIMenuLobbyFriendsSearchBox:OnMouseExit()
    baseClass.OnMouseExit(self)
    self.entry:OnMouseExit()
end

function GUIMenuLobbyFriendsSearchBox:OnMouseDrag()
    baseClass.OnMouseDrag(self)
    self.entry:OnMouseDrag()
end

function GUIMenuLobbyFriendsSearchBox:OnKey(key, down)
    baseClass.OnKey(self, key, down)
    return (self.entry:OnKey(key, down))
end

function GUIMenuLobbyFriendsSearchBox:OnCharacter(character)
    baseClass.OnCharacter(self, character)
    self.entry:OnCharacter(character)
end

function GUIMenuLobbyFriendsSearchBox:CancelEdit()
